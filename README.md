...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/60353cb59cfb300016205ab9
...
To start editing your site, you can use the Sanity interface at https://gatsby-sanity-53cb5.sanity.studio/.
...
Generated at `2021-02-23T17:42:02.473Z` by Stackbit version `0.3.49`.